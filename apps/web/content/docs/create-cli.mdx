...
The scaffold includes `skills/<app>-cli/SKILL.md` with placeholder sections. After implementing resources, update it with real capabilities, use cases, and the actual commands and flags.
